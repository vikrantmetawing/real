class RealController < ApplicationController
	...
	connection = ActiveRecord::Base.connection();
		...
		def master_user_validate
			...
			connection.execute(s)
			s="CREATE TABLE "+ "storiesses_"+$master_user_id.to_s+"(story_id SERIAL NOT NULL PRIMARY KEY,sub_user_id int,name varchar(100),email varchar(255),phone varchar(255),story varchar(255),image vaarchar(2))"
			connection.execute(s)
